...
export { loadImage, ImageCache, ImageFrame, ImageLayer, ImageViewer, TextLayer, MouseLayer, Matrix4x4, Vector4 };
export declare function renderViewer(elem: HTMLElement, data: InputTree, baseUrl?: string): void;
